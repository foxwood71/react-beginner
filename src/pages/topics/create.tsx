    ...
    <main className="w-full h-full min-h-[1024px] flex gap-6">
      ...
      <section className="w-3/4 h-full flex flex-col gap-6 p-6">
        <div className="flex flex-col pb-6 border-b">
          <span className="text-[#F96859] font-semibold">Step1</span>
          <span className="text-base font-semibold">토픽작성하기</span>
        </div>
        <div className="flex flex-col gap-2">
          <div className="flex items-center gap-1">
            <Asterisk size={14} className=" text-[#F96859]" />
            <Label className="text-muted-forground">제목</Label>
          </div>
          <Input
        ...
        <div className="flex flex-col gap-2">
          <div className="flex items-center gap-1">
            <Asterisk size={14} className=" text-[#F96859]" />
            <Label className="text-muted-forground">본문</Label>
          </div>
      ...
      <section className="w-1/4 h-full flex flex-col gap-6 p-6">
        <div className="flex flex-col pb-6 border-b">
          <span className="text-[#F96859] font-semibold">Step2</span>
          <span className="text-base font-semibold">카테고리 및 썸네일 등록</span>
        </div>
        <div className="flex flex-col gap-2">
          <div className="flex items-center gap-1">
            <Asterisk size={14} className=" text-[#F96859]" />
            <Label className="text-shadow-muted-foreground">카테고리</Label>
          </div>
          <Select>
            ...
            <SelectContent>
              <SelectGroup className="space-y-2">
                <SelectLabel className="text-slate-500 dark:text-slate-400 text-xs">카테고리(주제)</SelectLabel>
        ...
        <div className="flex flex-col gap-2">
          <div className="flex items-center gap-1">
            <Asterisk size={14} className=" text-[#F96859]" />
            <Label className="text-muted-forground">썸네일</Label>
          </div>
